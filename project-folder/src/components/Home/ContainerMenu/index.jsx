...
const card = tv({
    slots: {
        container: 'flex flex-col justify-center w-full h-48 md:w-[80%] md:h-56 lg:w-500 lg:h-80 2xl:w-700 2xl:h-400 mt-12 p-4 md:p-8 xl:p-12 lg:absolute lg:right-0 lg:bottom-20 xl:right-10 2xl:right-10 2xl:bottom-32 bg-box-background shadow-red rounded-md',
