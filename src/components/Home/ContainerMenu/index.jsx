...
const card = tv({
    slots: {
        container: 'flex flex-col justify-center w-full h-48 md:h-56 lg:w-500 lg:h-80 xl:h-250 2xl:w-700 2xl:h-300 mt-12 p-4 md:p-8 gap-y-8 md:gap-y-16 2xl:gap-y-24 lg:absolute lg:right-12 lg:bottom-20 xl:right-16 2xl:right-32 2xl:bottom-52 bg-box-background rounded-sm',
        menuText: 'text-xs md:text-sm 2xl:text-lg text-center text-white font-inter font-bold uppercase',
        buttonLink: 'relative flex items-center justify-center w-full h-12 2xl:h-16 bg-primary-red rounded-sm hover:bg-highlight-red hover:shadow-red cursor-pointer duration-200',
