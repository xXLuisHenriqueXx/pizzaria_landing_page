...
const card = tv({
    slots: {
        container: 'flex items-center justify-between lg:flex-col w-full md:w-1/2 lg:w-60 xl:w-72 2xl:w-80 h-32 lg:h-72 xl:h-80 2xl:h-450 px-10 lg:px-0 lg:py-8 2xl:py-14 mt-4 md:mx-auto lg:mx-0 bg-box-background rounded-xs hover:scale-105 cursor-pointer transition duration-200',
        image: 'w-24 h-24 xl:w-32 xl:h-32 2xl:w-40 2xl:h-40 p-2 2xl:p-4 bg-box-background-darker rounded-xs',
