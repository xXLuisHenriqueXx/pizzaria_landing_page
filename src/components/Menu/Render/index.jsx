...
const card = tv({
  slots: {
    containerSize:
      "flex flex-col lg:flex-row lg:items-center lg:justify-evenly w-full",
    containerPizzaDrink:
      "grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 md:place-items-center md:gap-x-4 xl:gap-x-8",
    infoText:
      "mt-4 text-xs md:text-sm font-inter font-medium text-white text-center uppercase",
    titleFlavorDrink:
      "md:col-span-2 2xl:col-span-3 w-full mt-4 text-xs md:text-sm xl:text-lg font-inter font-bold text-primary-red text-start uppercase",
    separator:
      "md:col-span-2 2xl:col-span-3 w-full h-0.5 bg-white mt-4 xl:mt-8 opacity-25",
  },
});
  ...
  return (
    <>
      {showPizzas && selectedSize === 0 && (
        <section>
          <h2 className={infoText()}>Escolha a pizza do tamanho da sua fome</h2>
      ...
      {showPizzas && selectedSize !== 0 && (
        <section>
          <h2 className={infoText()}>{flavorsText}</h2>
      ...
      {!showPizzas && (
        <section>
          <h2 className={infoText()}>Conheça nossas bebidas</h2>
